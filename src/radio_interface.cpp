...
void encrypt(uint8_t* buf){
  ...
  */
  ...
  buf[SPACEPACKET_ENCODED_HEADER_SIZE] = *iv + buf[SPACEPACKET_ENCODED_HEADER_SIZE]; // TODO: is the data_field_encrypted necessary if the apid tells us that it is?
}
